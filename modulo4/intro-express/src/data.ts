...
// coloquei junto com criação de usuário pois o código fica mais limpo e não achei necessário criar outro tipo, apenas acrescentei informações,
// pois caso preciso seja pegar apenas uma única informação, crio isso em endpoints separados.
